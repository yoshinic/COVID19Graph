...
struct HospitalizationController: DownloadController {
    typealias Model = Hospitalization
...
// 新規 or 更新を判断してから保存
extension HospitalizationController {
...
extension HospitalizationController {
    func add(_ a: [String]) -> EventLoopFuture<Hospitalization> {
